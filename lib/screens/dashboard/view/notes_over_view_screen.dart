                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            Obx(() {
                              if (taskController.allTasks.value is Success) {
                                List<ResponseData> tasks =
                                    (taskController.allTasks.value as Success)
                                        .data;
                                return Column(
                              ...
                              } else if (taskController.allTasks.value
                                  is Error) {
                                var error =
                                    (taskController.allTasks.value as Error)
                                        .msg;
                            ...
                            if (taskController.allTasks.value is! Success ||
                                (taskController.allTasks.value
                                        as Success<List<ResponseData>>)
                                    .data
                                    .isNotEmpty)
                              const Padding(
